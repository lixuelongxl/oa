	...
	$.ajax({
		...
		success : function(data) {
			if (data.status == "500") {
				...
				if(data.list.documentFlow.printFlag=="1")
				{
					$(".js-printbtn").show();
				}
				...
				if(data.list.documentFlow.attachPriv=="1")
				{
				...
				createrunProcessList(data.list.allDocumentRunProcess);
