...
function query()
	{
		 $("#myTable").bootstrapTable({
		      url: '/ret/sysget/getCodeClassList',
		      method: 'post',
...
function edit(codeClassId)
{
	...
	$(".js-save").unbind("click").click(function(){
		$.ajax({
			url : "/set/sysset/updateCodeClass",
			type : "post",
			dataType : "json",
			data:{
...
function del(codeClassId)
{
	 if(confirm("确定删除当前分类吗？"))
	    {
	$.ajax({
		url : "/set/sysset/deleteCodeClass",
		type : "post",
		dataType : "json",
		data:{
			codeClassId:codeClassId
...
$(".js-save").unbind("click").click(function(){
	$.ajax({
		url : "/set/sysset/insertCodeClass",
		type : "post",
		dataType : "json",
		data:{
			sortNo:$("#sortNo").val(),
...
function dodelAll()
{
	...
	}else
	{
	    ...
	    {
		$.ajax({
			url : "/set/sysset/deleteCodeClassBatch",
			type : "post",
			dataType : "json",
			data:{
